...
L["Start blinking when this percentage of duration remains"] = "當剩餘時間百分比低於此值時開始閃爍"
L["Buffs and debuffs will start blinking when their remaining time falls below this percentage of their total duration."] = "當增益和減益效果的剩餘時間低於其總持續時間的此百分比時，它們將開始閃爍。"
L["Background transparency"] = "背景透明度"
L["Adjust the transparency of the duration text background"] = "調整持續時間文字背景的透明度"
L["When enabled, Masque will override all border settings including colors and style."] = "啟用後，Masque將覆蓋所有邊框設置，包括顏色和樣式。"
L["Masque support enabled"] = "Masque支持已啟用"
L["Masque support disabled"] = "Masque支持已禁用"
L["Border settings are now controlled by Masque"] = "邊框設置現在由Masque控制"
L["Border settings restored to addon defaults"] = "邊框設置已恢復為插件默認值"
L["Also in Performance tab"] = "也在性能選項卡中"
L["This setting is also available in the Performance tab."] = "此設置也可在性能選項卡中找到。"

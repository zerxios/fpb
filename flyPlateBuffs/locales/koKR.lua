...
L["Start blinking when this percentage of duration remains"] = "이 비율의 지속시간이 남아있을 때 깜박이기 시작"
L["Buffs and debuffs will start blinking when their remaining time falls below this percentage of their total duration."] = "버프와 디버프는 남은 시간이 총 지속시간의 이 비율 이하로 떨어질 때 깜박이기 시작합니다."
L["Background transparency"] = "배경 투명도"
L["Adjust the transparency of the duration text background"] = "지속시간 텍스트 배경의 투명도 조정"
L["When enabled, Masque will override all border settings including colors and style."] = "활성화하면 Masque가 색상 및 스타일을 포함한 모든 테두리 설정을 재정의합니다."
L["Masque support enabled"] = "Masque 지원 활성화됨"
L["Masque support disabled"] = "Masque 지원 비활성화됨"
L["Border settings are now controlled by Masque"] = "테두리 설정이 이제 Masque에 의해 제어됩니다"
L["Border settings restored to addon defaults"] = "테두리 설정이 애드온 기본값으로 복원되었습니다"
L["Also in Performance tab"] = "성능 탭에도 있음"
L["This setting is also available in the Performance tab."] = "이 설정은 성능 탭에서도 사용할 수 있습니다."

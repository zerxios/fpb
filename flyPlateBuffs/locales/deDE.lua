...
L["Start blinking when this percentage of duration remains"] = "Beginnt zu blinken, wenn dieser Prozentsatz der Dauer verbleibt"
L["Buffs and debuffs will start blinking when their remaining time falls below this percentage of their total duration."] = "Stärkungs- und Schwächungszauber beginnen zu blinken, wenn ihre verbleibende Zeit unter diesen Prozentsatz ihrer Gesamtdauer fällt."
L["Background transparency"] = "Hintergrund-Transparenz"
L["Adjust the transparency of the duration text background"] = "Passen Sie die Transparenz des Hintergrunds für den Dauertext an"
L["Background padding"] = "Hintergrund-Abstand"
L["Amount of padding around duration text for positions with backgrounds"] = "Abstand um den Dauertext für Positionen mit Hintergründen"
L["Controls the size of the black background behind duration text."] = "Steuert die Größe des schwarzen Hintergrunds hinter dem Dauertext."
L["Small (1 pixel)"] = "Klein (1 Pixel)"
L["Medium (2 pixels)"] = "Mittel (2 Pixel)"
L["Large (3 pixels)"] = "Groß (3 Pixel)"
L["Extra Large (4 pixels)"] = "Extra Groß (4 Pixel)"
L["When enabled, Masque will override all border settings including colors and style."] = "Wenn aktiviert, überschreibt Masque alle Rahmeneinstellungen, einschließlich Farben und Stil."
L["Masque support enabled"] = "Masque-Unterstützung aktiviert"
L["Masque support disabled"] = "Masque-Unterstützung deaktiviert"
L["Border settings are now controlled by Masque"] = "Rahmeneinstellungen werden jetzt von Masque gesteuert"
L["Border settings restored to addon defaults"] = "Rahmeneinstellungen auf Addon-Standardwerte zurückgesetzt"
L["Also in Performance tab"] = "Auch im Leistungstab"
L["This setting is also available in the Performance tab."] = "Diese Einstellung ist auch im Leistungstab verfügbar."
